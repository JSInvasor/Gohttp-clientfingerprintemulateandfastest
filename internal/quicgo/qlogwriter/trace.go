...
import (
	...
	"github.com/JSInvasor/Gohttp-clientfingerprintemulateandfastest/internal/quicgo/qlogwriter/jsontext"
)
...
// -ldflags="-X github.com/JSInvasor/Gohttp-clientfingerprintemulateandfastest/internal/quicgo/qlogwriter.quicGoVersion=foobar"
...
func init() {
	...
	for _, d := range info.Deps {
		if d.Path == "github.com/JSInvasor/Gohttp-clientfingerprintemulateandfastest/internal/quicgo" {
