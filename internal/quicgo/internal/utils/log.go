...
func readLoggingEnv() LogLevel {
	...
	default:
		fmt.Fprintln(os.Stderr, "invalid quic-go log level, see https://github.com/JSInvasor/Gohttp-clientfingerprintemulateandfastest/internal/quicgo/wiki/Logging")
		return LogLevelNothing
	}
}
